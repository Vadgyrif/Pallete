...
class __TwigTemplate_6cf3e4bc6fa3261bfd8e1b9d565edbd3 extends Template
{
    private $source;
    private $macros = [];
...
$context["item"], "in_active_trail", [], "any", false, false, true, 50)) ? ("active") : ("")), ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,                     // line 51
$context["item"], "url", [], "any", false, false, true, 51), "getOption", ["attributes"], "method", false, false, true, 51), "class", [], "any", false, false, true, 51)) ? (twig_join_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 51), "getOption", ["attributes"], "method", false, false, true, 51), "class", [], "any", false, false, true, 51), 51, $this->source), "")) : ("")), ("nav-link-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,                     // line 52
$context["item"], "url", [], "any", false, false, true, 52), "toString", [], "method", false, false, true, 52), 52, $this->source)))];
  ...
  ";
    ...
    {
        return array (  128 => 61,  121 => 59,  115 => 57,  113 => 56,  108 => 55,  106 => 52,  105 => 51,  104 => 50,  103 => 48,  98 => 46,  96 => 43,  95 => 42,  94 => 41,  93 => 39,  91 => 38,  86 => 37,  82 => 35,  76 => 33,  73 => 32,  70 => 31,  67 => 30,  52 => 29,  44 => 27,  41 => 22,  39 => 21,);
    }
